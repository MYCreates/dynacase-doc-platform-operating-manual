...
Syntaxe `list context [--pretty]`  
Description : Cette opération permet d'afficher les contextes installés.   
Exemple
...
Syntaxe : `context <context-name> module list installed [--pretty]`  
Exemple
...
Syntaxe : `context <context-name> module list available [--pretty]`  
Exemple
...
###### Modules avec mise à jour proposée
...
Syntaxe : `context <context-name> module list upgrade [--pretty]`  
Exemple
